...
function AddSheep() {
  ...
  function validate(formData) {
    ...
    if (!formData.number) {
      errors.number = "Neivestas avies numeris";
    }
    if (!formData.mother) {
      errors.mother = "Neivestas motinos numeris";
    } else {
      if (formData.number.length !== 7) {
        errors.number = "Numeris privalo tureti 7 simbolius";
      }
    }
  ...
  function formErrors(errors) {
    ...
    alert(`Klaidos: ${errors.number}  ${errors.mother}`);
  }
